...
export const LANDING_CONTENT: Record<"en" | "fr", LangContent> = {
  en: {
    ...
    stats: {
      ...
      items: [
        { value: "14,000+", label: "garments catalogued" },
        { value: "44,000+", label: "AI style analyses" },
        { value: "2,100+", label: "App Store downloads" },
        { value: "2,400+", label: "outfits styled" },
      ],
  ...
  fr: {
    ...
    stats: {
      ...
      items: [
        { value: "14 000+", label: "vêtements catalogués" },
        { value: "44 000+", label: "analyses de style par l'IA" },
        { value: "2 100+", label: "téléchargements App Store" },
        { value: "2 400+", label: "tenues composées" },
      ],
