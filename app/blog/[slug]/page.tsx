...
const FAQ_BY_SLUG: Record<string, { q: string; a: string }[]> = {
  ...
  "ai-outfit-planner-does-it-work": [
    ...
    { q: "Is there a free AI outfit planner?", a: "Yes. Margot is free to download on the App Store, with daily outfit suggestions from your own wardrobe. A Premium tier ($9.99/month or $39.99/year) unlocks unlimited suggestions plus the shopping and resale features." },
  ],
  "alternative-to-whering": [
    ...
    { q: "Is Margot free like Whering?", a: "Both have a free tier. Margot is free to download on the App Store, with an optional Premium tier at $9.99/month or $39.99/year." },
