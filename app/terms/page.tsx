      ...
      <article className="max-w-[760px] mx-auto">
        ...
        <Section>
          <P>
            ...
            mobile application operated by Yassine Benlahmr ("we", "us", "our"). By creating
            an account, downloading, or otherwise using Margot (the "App"), you agree to be
        ...
        <Section title="1. The service">
          <P>
            Margot helps you digitise your wardrobe, plan outfits with AI assistance, and
            decide whether new clothing items fit your existing closet. We may add, remove,
            or modify features at any time without notice.
          </P>
          <P>
            Margot's outfit recommendations, sustainability scores, cost-per-wear estimates,
            and styling rules are generated by software, including third-party AI models.{" "}
            <Strong>
        ...
        <Section title="2. Eligibility and account">
          ...
          <P>
            ...
            <a href="mailto:support@margotwardrobe.com" className="underline hover:text-peach">
              support@margotwardrobe.com
            </a>
            .
          </P>
          <P>
        ...
        <Section title="14. Contact">
          <P>
            ...
            <a
              href="mailto:support@margotwardrobe.com"
              className="underline hover:text-peach"
            >
              support@margotwardrobe.com
            </a>{" "}
