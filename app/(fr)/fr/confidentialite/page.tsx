...
export const metadata: Metadata = {
  ...
  description:
    "Comment Margot collecte et traite tes données, utilise les photos soumises aux fonctions IA et te permet d’exercer tes droits ou de supprimer ton compte.",
